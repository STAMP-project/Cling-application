...
By running the following bash script, the stack traces captured by all of the genrated test cases will be stored id `data/rq3/stack-traces`
...
Currently, the captured stack traces in our study is available in `data/rq3/stack-traces`.
