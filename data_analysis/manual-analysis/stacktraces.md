This file contains the list of test cases generated by CLING that throw an unexpected exception triggered **only** by CLING (and not EvoSuite or Randoop). Those test cases have been manually analysed and classified as [faut-revealing](failure-explanation.md) or [non-fault-revealing](non-failure-stacktraces.md). 
