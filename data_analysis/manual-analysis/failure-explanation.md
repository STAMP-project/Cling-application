...
This file contains the test cases generated by CLING that throw an unexpected exception triggered **only** by CLING (and not EvoSuite or Randoop) and that have been classified as fault revealing tests by our manual analysis. The explanation details for each test the reason of this classification. 
