...
do
  ...
  TestsDir="results/randoop10/$project-$caller_class-$callee_class-$execution_id"
  echo $TestsDir
  ...
  # echo $TestsDir
  # echo "logs/randoop$timeInMinute/$project-$caller_class-$callee_class-$execution_id-out.txt"
  # echo "logs/randoop$timeInMinute/$project-$caller_class-$callee_class-$execution_id-err.txt"
  # echo "___________________________"

done < $INPUT

echo "finished: $finishedCounter"
echo "unfinished: $resultcounter"