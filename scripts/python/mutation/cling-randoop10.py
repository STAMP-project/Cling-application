...
with open(os.path.join(data_path,'randoopKilled.csv'), 'r') as t1, open(os.path.join(data_path,'clingKilled.csv'), 'r') as t2:
    ...
    counter = 0
    with open(os.path.join(data_path,'cling-randoop10.csv'), 'w') as outFile:
        outFile.write("executionId"+",project"+",caller"+",callee"+",mutator"+",method"+",line"+",T10status"+"\r\n")
            ...
            if line not in filethree:
                ...
                if os.path.isfile(randoop10ReportDir):
                    ...
                    with open(randoop10ReportDir, 'r') as _reporthandler:
                        ...
                        if statusInE == "":
                            print "status in randoop test mutation report is empty"
                else:
                    statusInE="NO_COVERAGE"

                outFile.write(line+", Status in Ran10 is "+statusInE+"\r\n")