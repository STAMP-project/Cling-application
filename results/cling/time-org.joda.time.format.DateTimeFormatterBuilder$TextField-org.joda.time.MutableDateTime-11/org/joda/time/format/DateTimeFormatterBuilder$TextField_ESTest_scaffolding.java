...
public class DateTimeFormatterBuilder$TextField_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.format.DateTimeFormatterBuilder$TextField"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DateTimeFormatterBuilder$TextField_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.DateTimeFieldType", false, DateTimeFormatterBuilder$TextField_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimeParserBucket", false, DateTimeFormatterBuilder$TextField_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DateTimeFormatterBuilder$TextField_ESTest_scaffolding.class.getClassLoader()); 
