...
public class NelderMead_ESTest extends NelderMead_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(1103.920742, 0.0, 0.0, 0.0, 0.0).when(costFunction0).cost(any(double[].class));
      ...
      nelderMead0.minimize(costFunction0, 389, convergenceChecker0, doubleArray0, 389, 0L);
  }
  ...
  public void test1()  throws Throwable  {
      NelderMead nelderMead0 = new NelderMead();
      CostFunction costFunction0 = mock(CostFunction.class, new ViolatedAssumptionAnswer());
      doReturn((double)(-67), 3.0, 1.0E-12, 3500.56694269).when(costFunction0).cost(any(double[].class));
      ConvergenceChecker convergenceChecker0 = mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn(true).when(convergenceChecker0).converged(any(org.apache.commons.math.optimization.PointCostPair[].class));
      double[] doubleArray0 = new double[3];
      PointCostPair pointCostPair0 = nelderMead0.minimize(costFunction0, (-67), convergenceChecker0, doubleArray0, doubleArray0, (-67), (long) (-67));
      assertEquals((-67.0), pointCostPair0.getCost(), 0.01);
  }
  ...
  public void test2()  throws Throwable  {
      ...
      nelderMead0.minimize(costFunction0, 119, convergenceChecker0, (RandomVectorGenerator) uncorrelatedRandomVectorGenerator0);
  ...
  public void test3()  throws Throwable  {
      ...
      doReturn(4197.93595359655).when(costFunction1).cost(any(double[].class));
      ...
      nelderMead0.minimize(costFunction1, (-184), convergenceChecker1, doubleArray0, (-184), (long) (-184));
      try { 
        nelderMead0.minimize(costFunction0, (-184), convergenceChecker0, doubleArray1, doubleArray1);
  ...
  public void test4()  throws Throwable  {
      NelderMead nelderMead0 = new NelderMead();
      CostFunction costFunction0 = mock(CostFunction.class, new ViolatedAssumptionAnswer());
      doReturn(1103.920742, 1103.920742, 1103.920742, 417.56937007, (-2534.252437)).when(costFunction0).cost(any(double[].class));
      ConvergenceChecker convergenceChecker0 = mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      ...
      try { 
        nelderMead0.minimize(costFunction0, 76, convergenceChecker0, doubleArray0, doubleArray0, 76, (long) 17);
        fail("Expecting exception: ConvergenceException");
      
      } catch(ConvergenceException e) {
         //
         // none of the 76 start points lead to convergence
         //
         verifyException("org.apache.commons.math.optimization.DirectSearchOptimizer", e);
      }
  }
