...
public class EthiopicChronology_ESTest extends EthiopicChronology_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("4", (String) null).when(dateTimeZone0).getID();
      ...
      assertEquals("EthiopicChronology[null,mdfw=7]", string0);
  }
  ...
  public void test2()  throws Throwable  {
      EthiopicChronology ethiopicChronology0 = EthiopicChronology.getInstance();
      int int0 = ethiopicChronology0.getDaysInYear(31);
  ...
  public void test3()  throws Throwable  {
      EthiopicChronology ethiopicChronology0 = EthiopicChronology.getInstance();
      int int0 = ethiopicChronology0.getDaysInYear(30);
