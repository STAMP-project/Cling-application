...
public class UnicodeEscaper_ESTest extends UnicodeEscaper_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1023);
  ...
  public void test1()  throws Throwable  {
      ...
      boolean boolean0 = unicodeEscaper0.translate(38, writer0);
      assertTrue(boolean0);
  }
  ...
  public void test2()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1023);
      CharBuffer charBuffer0 = CharBuffer.allocate(982);
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) charBuffer0, (Writer) stringWriter0);
      assertEquals(982, charBuffer0.length());
  }
}
