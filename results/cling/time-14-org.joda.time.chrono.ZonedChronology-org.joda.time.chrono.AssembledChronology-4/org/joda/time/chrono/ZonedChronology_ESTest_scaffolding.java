...
public class ZonedChronology_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, ZonedChronology_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeZone", false, ZonedChronology_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, ZonedChronology_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, ZonedChronology_ESTest_scaffolding.class.getClassLoader()));
  }
