...
public class IslamicChronology_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.chrono.IslamicChronology"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IslamicChronology_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.DateTimeZone", false, IslamicChronology_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.chrono.IslamicChronology$LeapYearPatternType", false, IslamicChronology_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IslamicChronology_ESTest_scaffolding.class.getClassLoader()); 
