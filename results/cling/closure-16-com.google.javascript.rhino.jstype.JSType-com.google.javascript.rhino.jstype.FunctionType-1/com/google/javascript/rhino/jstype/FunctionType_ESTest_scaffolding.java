...
public class FunctionType_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.javascript.rhino.ErrorReporter", false, FunctionType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.jstype.JSTypeRegistry", false, FunctionType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.jstype.ObjectType", false, FunctionType_ESTest_scaffolding.class.getClassLoader()));
  }
