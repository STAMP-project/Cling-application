...
public class MutableInterval_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.MutableInterval"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MutableInterval_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, MutableInterval_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.ReadableDuration", false, MutableInterval_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.ReadableInstant", false, MutableInterval_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MutableInterval_ESTest_scaffolding.class.getClassLoader()); 
