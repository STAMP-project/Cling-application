...
public class MatrixUtils_ESTest extends MatrixUtils_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      RealMatrix realMatrix0 = MatrixUtils.createRealIdentityMatrix(60);
      assertEquals(60, realMatrix0.getColumnDimension());
  ...
  public void test5()  throws Throwable  {
      BigMatrixImpl bigMatrixImpl0 = (BigMatrixImpl)MatrixUtils.createBigIdentityMatrix(47);
      assertEquals(64, bigMatrixImpl0.getScale());
      assertEquals(4, bigMatrixImpl0.getRoundingMode());
      assertTrue(bigMatrixImpl0.isSquare());
      assertEquals(47, bigMatrixImpl0.getRowDimension());
  }
}
