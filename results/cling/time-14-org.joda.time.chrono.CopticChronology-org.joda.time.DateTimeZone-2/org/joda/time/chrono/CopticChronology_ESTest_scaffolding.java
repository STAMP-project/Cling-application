...
public class CopticChronology_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.chrono.CopticChronology"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CopticChronology_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.DateTimeZone", false, CopticChronology_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.chrono.AssembledChronology$Fields", false, CopticChronology_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CopticChronology_ESTest_scaffolding.class.getClassLoader()); 
