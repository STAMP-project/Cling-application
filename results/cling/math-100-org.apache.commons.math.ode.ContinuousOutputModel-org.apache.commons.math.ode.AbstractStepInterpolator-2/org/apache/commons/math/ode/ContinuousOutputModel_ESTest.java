...
public class ContinuousOutputModel_ESTest extends ContinuousOutputModel_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[6];
      DummyStepInterpolator dummyStepInterpolator0 = new DummyStepInterpolator(doubleArray0, false);
      dummyStepInterpolator0.previousTime = (-4095.3);
      continuousOutputModel0.handleStep(dummyStepInterpolator0, false);
      continuousOutputModel0.setInterpolatedTime(0.0);
      assertEquals((-4095.3), continuousOutputModel0.getInitialTime(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      dummyStepInterpolator0.previousTime = 2224.14044187037;
      continuousOutputModel0.handleStep(dummyStepInterpolator0, true);
      continuousOutputModel0.setInterpolatedTime((-1216.7789636));
      assertEquals(2224.14044187037, continuousOutputModel0.getInitialTime(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[2];
      DummyStepInterpolator dummyStepInterpolator0 = new DummyStepInterpolator(doubleArray0, false);
      dummyStepInterpolator0.currentTime = (-540.19064414);
      continuousOutputModel0.handleStep(dummyStepInterpolator0, true);
      continuousOutputModel0.setInterpolatedTime((-1203.3942083870716));
      ContinuousOutputModel continuousOutputModel1 = new ContinuousOutputModel();
      continuousOutputModel1.append(continuousOutputModel0);
      assertEquals((-540.19064414), continuousOutputModel0.getFinalTime(), 0.01);
      assertEquals((-1203.3942083870716), continuousOutputModel0.getInterpolatedTime(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      dummyStepInterpolator0.currentTime = 0.0;
      continuousOutputModel0.handleStep(dummyStepInterpolator0, false);
      continuousOutputModel0.setInterpolatedTime((-540.19064414));
      // Undeclared exception!
      try { 
        continuousOutputModel0.append(continuousOutputModel0);
        fail("Expecting exception: ConcurrentModificationException");
