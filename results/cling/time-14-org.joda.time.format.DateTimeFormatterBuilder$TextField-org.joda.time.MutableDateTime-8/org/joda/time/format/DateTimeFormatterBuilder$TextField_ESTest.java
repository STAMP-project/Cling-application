...
public class DateTimeFormatterBuilder$TextField_ESTest extends DateTimeFormatterBuilder$TextField_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      dateTimeFormatterBuilder_TextField0.parseInto(dateTimeParserBucket0, "VHAUbEqci<", 1);
      ...
      DateTimeParserBucket dateTimeParserBucket1 = new DateTimeParserBucket((-2), buddhistChronology0, locale0, (Integer) 1, (-2));
      // Undeclared exception!
      try { 
        dateTimeFormatterBuilder_TextField1.parseInto(dateTimeParserBucket1, "VHAUbEqci<", (-2));
