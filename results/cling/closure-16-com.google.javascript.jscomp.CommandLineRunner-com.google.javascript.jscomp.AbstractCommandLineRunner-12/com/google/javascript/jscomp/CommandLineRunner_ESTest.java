...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      linkedList0.add("--define klag syntas invalid: ");
      String[] stringArray0 = new String[5];
      stringArray0[0] = "--define klag syntas invalid: ";
      stringArray0[1] = "jU";
      stringArray0[2] = "--define klag syntas invalid: ";
      stringArray0[3] = "--define klag syntas invalid: ";
      stringArray0[4] = "--define klag syntas invalid: ";
      ...
      try { 
        ...
        fail("Expecting exception: AbstractCommandLineRunner.FlagUsageException");
         ...
         //
         // Invalid module name: '--define klag syntas invalid'
         //
         verifyException("com.google.javascript.jscomp.AbstractCommandLineRunner", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        AbstractCommandLineRunner.writeOutput(charBuffer0, (Compiler) null, "Can't reove external name-only defnition", "w3c_selectors.js", "Can't reove external name-only defnition");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        AbstractCommandLineRunner.parseModuleWrappers(linkedList0, arrayList0);
        fail("Expecting exception: AbstractCommandLineRunner.FlagUsageException");
      
      } catch(AbstractCommandLineRunner.FlagUsageException e) {
         //
         // Unknown module: '--define klag syntas invalid'
         //
         verifyException("com.google.javascript.jscomp.AbstractCommandLineRunner", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      String[] stringArray0 = new String[0];
      CommandLineRunner commandLineRunner0 = new CommandLineRunner(stringArray0);
      commandLineRunner0.checkModuleName("G8f");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // --tweak flag syntax invalid: 3B%=K^
         //
         verifyException("com.google.javascript.jscomp.AbstractCommandLineRunner", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      AbstractCommandLineRunner.writeOutput(charBuffer0, (Compiler) null, "", "no", "no");
  ...
  public void test21()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          // Undeclared exception!
          try { 
            commandLineRunner0.filenameToOutputStream("T@IXP");
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"T@IXP\" \"write\")
             // java.lang.Thread.getStackTrace(Thread.java:1559)
             // org.evosuite.runtime.sandbox.MSecurityManager.checkPermission(MSecurityManager.java:434)
