...
public class IdScriptableObject_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.javascript.rhino.head.Callable", false, IdScriptableObject_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.Context", false, IdScriptableObject_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.ContextFactory", false, IdScriptableObject_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.NativeFunction", false, IdScriptableObject_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.Scriptable", false, IdScriptableObject_ESTest_scaffolding.class.getClassLoader()));
  }
