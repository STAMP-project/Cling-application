...
public class IRFactory_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.google.javascript.rhino.head.ast.ArrayLiteral", false, IRFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.ast.AstRoot", false, IRFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.ast.ElementGet", false, IRFactory_ESTest_scaffolding.class.getClassLoader()));
