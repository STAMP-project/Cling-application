...
public class ZonedChronology$ZonedDateTimeField_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.chrono.ZonedChronology$ZonedDateTimeField"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ZonedChronology$ZonedDateTimeField_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ZonedChronology$ZonedDateTimeField_ESTest_scaffolding.class.getClassLoader()); 
