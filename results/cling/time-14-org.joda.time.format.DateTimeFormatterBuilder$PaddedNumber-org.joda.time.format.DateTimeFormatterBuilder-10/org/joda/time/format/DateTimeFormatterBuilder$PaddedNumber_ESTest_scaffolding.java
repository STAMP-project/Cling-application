...
public class DateTimeFormatterBuilder$PaddedNumber_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.format.DateTimeFormatterBuilder$PaddedNumber"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DateTimeFormatterBuilder$PaddedNumber_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Writer", false, DateTimeFormatterBuilder$PaddedNumber_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeFieldType", false, DateTimeFormatterBuilder$PaddedNumber_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DateTimeFormatterBuilder$PaddedNumber_ESTest_scaffolding.class.getClassLoader()); 
