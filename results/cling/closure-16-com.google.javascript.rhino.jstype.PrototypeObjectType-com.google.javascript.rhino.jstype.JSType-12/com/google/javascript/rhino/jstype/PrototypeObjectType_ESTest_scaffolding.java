...
public class PrototypeObjectType_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.javascript.rhino.ErrorReporter", false, PrototypeObjectType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.JSDocInfo", false, PrototypeObjectType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.Node", false, PrototypeObjectType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.jstype.JSTypeRegistry", false, PrototypeObjectType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.jstype.ObjectType", false, PrototypeObjectType_ESTest_scaffolding.class.getClassLoader()));
  }
