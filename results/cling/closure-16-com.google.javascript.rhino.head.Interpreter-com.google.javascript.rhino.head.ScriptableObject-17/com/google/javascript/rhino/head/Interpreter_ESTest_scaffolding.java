...
public class Interpreter_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.google.javascript.rhino.head.NativeContinuation", false, Interpreter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.NativeFunction", false, Interpreter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.Scriptable", false, Interpreter_ESTest_scaffolding.class.getClassLoader()));
  }
