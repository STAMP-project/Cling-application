...
public class NativeRegExp_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.javascript.rhino.head.Context", false, NativeRegExp_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.IdFunctionObject", false, NativeRegExp_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.head.Scriptable", false, NativeRegExp_ESTest_scaffolding.class.getClassLoader()));
  }
