...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // --tweak flag syntax invalid: 4&f:^1gFJ$2W=u9Y4
         //
         verifyException("com.google.javascript.jscomp.AbstractCommandLineRunner", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      stringArray0[0] = "verbose:pretty:all";
      stringArray0[1] = "verbose:pretty:all";
      stringArray0[2] = "verbose:pretty:all";
      stringArray0[3] = "verbose:pretty:all";
      stringArray0[4] = "verbose:pretty:all";
      stringArray0[5] = "{IxUil0(5:i\"0";
      stringArray0[6] = "verbose:pretty:all";
      CommandLineRunner commandLineRunner0 = new CommandLineRunner(stringArray0);
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      Map<String, String> map0 = AbstractCommandLineRunner.parseModuleWrappers(vector0, vector1);
  ...
  public void test17()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          // Undeclared exception!
          try { 
            commandLineRunner0.filenameToOutputStream("w3c_dom1.js");
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"w3c_dom1.js\" \"write\")
             // java.lang.Thread.getStackTrace(Thread.java:1559)
             // org.evosuite.runtime.sandbox.MSecurityManager.checkPermission(MSecurityManager.java:434)
