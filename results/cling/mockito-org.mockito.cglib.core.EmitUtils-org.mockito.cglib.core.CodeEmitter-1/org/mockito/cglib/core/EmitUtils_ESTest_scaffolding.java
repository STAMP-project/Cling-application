...
public class EmitUtils_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.mockito.cglib.core.EmitUtils"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EmitUtils_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.mockito.asm.Label", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.asm.Type", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.Block", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.ClassEmitter", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.CodeEmitter", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.Customizer", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.ObjectSwitchCallback", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mockito.cglib.core.ProcessSwitchCallback", false, EmitUtils_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EmitUtils_ESTest_scaffolding.class.getClassLoader()); 
