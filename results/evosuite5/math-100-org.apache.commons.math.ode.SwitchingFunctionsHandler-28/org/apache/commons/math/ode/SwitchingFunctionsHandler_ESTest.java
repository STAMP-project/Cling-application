...
public class SwitchingFunctionsHandler_ESTest extends SwitchingFunctionsHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn((-1220.0), 2833.93, Double.NaN, 0.0, (-1220.0)).when(switchingFunction0).g(anyDouble() , any(double[].class));
      switchingFunctionsHandler0.add(switchingFunction0, Double.NaN, 1072, 1072);
      double[] doubleArray0 = new double[6];
      DummyStepInterpolator dummyStepInterpolator0 = new DummyStepInterpolator(doubleArray0, false);
      boolean boolean0 = switchingFunctionsHandler0.evaluateStep(dummyStepInterpolator0);
      assertTrue(boolean0);
      
      switchingFunctionsHandler0.stepAccepted((-858.707003978716), doubleArray0);
      boolean boolean1 = switchingFunctionsHandler0.reset((-2729.5051752533745), doubleArray0);
      assertTrue(boolean1);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      switchingFunctionsHandler0.add(switchingFunction0, Double.NaN, 1072, 1072);
      double[] doubleArray0 = new double[6];
      boolean boolean0 = switchingFunctionsHandler0.reset((-2729.5051752533745), doubleArray0);
  ...
  public void test05()  throws Throwable  {
      SwitchingFunctionsHandler switchingFunctionsHandler0 = new SwitchingFunctionsHandler();
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      doReturn(Double.NaN, (double)1072, Double.NaN, 0.0).when(switchingFunction0).g(anyDouble() , any(double[].class));
      switchingFunctionsHandler0.add(switchingFunction0, Double.NaN, 1072, 1072);
  ...
  public void test09()  throws Throwable  {
      ...
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      switchingFunctionsHandler0.add(switchingFunction0, (-856), (-856), (-856));
      boolean boolean0 = switchingFunctionsHandler0.isEmpty();
      assertFalse(boolean0);
  }
