...
public class SwitchingFunctionsHandler_ESTest extends SwitchingFunctionsHandler_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      switchingFunctionsHandler0.add(switchingFunction0, (-3066), (-3066), (-3066));
  ...
  public void test2()  throws Throwable  {
      SwitchingFunctionsHandler switchingFunctionsHandler0 = new SwitchingFunctionsHandler();
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      doReturn((double)917).when(switchingFunction0).g(anyDouble() , any(double[].class));
      switchingFunctionsHandler0.add(switchingFunction0, 917, 917, 917);
      switchingFunctionsHandler0.stepAccepted(917, (double[]) null);
  ...
  public void test4()  throws Throwable  {
      SwitchingFunctionsHandler switchingFunctionsHandler0 = new SwitchingFunctionsHandler();
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      doReturn((double)(-1), (double)(-1), 0.0, 0.0, 0.0).when(switchingFunction0).g(anyDouble() , any(double[].class));
  ...
  public void test7()  throws Throwable  {
      ...
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      switchingFunctionsHandler0.add(switchingFunction0, (-3103), (-3103), (-3103));
      boolean boolean0 = switchingFunctionsHandler0.isEmpty();
      assertFalse(boolean0);
  }
