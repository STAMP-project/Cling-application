...
public class FastFourierTransformer_ESTest extends FastFourierTransformer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      fastFourierTransformer0.computeOmega((-1600));
      fastFourierTransformer0.computeOmega((-1600));
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        fastFourierTransformer0.transform((UnivariateRealFunction) polynomialFunction0, 0.0, (-617.03685168575), 52);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Endpoints do not specify an interval: [0.0, -617.03685168575]
         //
         verifyException("org.apache.commons.math.transform.FastFourierTransformer", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      PolynomialFunction polynomialFunction0 = new PolynomialFunction(doubleArray0);
      try { 
        fastFourierTransformer0.transform2((UnivariateRealFunction) polynomialFunction0, 0.0, (-615.0), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      FastFourierTransformer fastFourierTransformer0 = new FastFourierTransformer();
      try { 
        fastFourierTransformer0.inversetransform((UnivariateRealFunction) polynomialFunction0, (double) 0, (-1.0), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      PolynomialFunction polynomialFunction0 = new PolynomialFunction(doubleArray0);
      try { 
        fastFourierTransformer0.inversetransform2((UnivariateRealFunction) polynomialFunction0, 0.0, 3720.96134416264, 1777);
        fail("Expecting exception: IllegalArgumentException");
