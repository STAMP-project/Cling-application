...
public class FieldProviderTransformer_ESTest extends FieldProviderTransformer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.visit(3, 3, ")Rq`[dD.bq~t_g", ")Rq`[dD.bq~t_g", ")Rq`[dD.bq~t_g", stringArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.visit((-34), (-34), ")Rq`[dD.bq~t_g", ")Rq`[dD.bq~t_g", ")Rq`[dD.bq~t_g", stringArray0);
        fail("Expecting exception: NullPointerException");
