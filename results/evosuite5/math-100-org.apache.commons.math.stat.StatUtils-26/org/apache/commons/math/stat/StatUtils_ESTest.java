...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      double double0 = StatUtils.varianceDifference(doubleArray0, doubleArray0, (-1560.225422));
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray1, doubleArray0, 403.66);
  ...
  public void test02()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, (-2410.2813496693));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 1, 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, (-1807), (-1807));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.product((double[]) null, 19, 19);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.sumSq((double[]) null, 2, 2);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.min(doubleArray0, (-3768), (-3768));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, (-1), 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 0.0, 2197, 1527);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 0, 636);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.geometricMean((double[]) null, 2856, 2856);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-1), 864, (-850.5498975530664));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.variance((double[]) null, 0.0);
