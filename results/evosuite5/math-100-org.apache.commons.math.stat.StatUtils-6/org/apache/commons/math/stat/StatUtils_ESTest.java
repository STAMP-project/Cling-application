...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      double double0 = StatUtils.varianceDifference(doubleArray0, doubleArray0, 683.726424);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, (-978.11207089532));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      double[] doubleArray0 = new double[4];
      double double0 = StatUtils.mean(doubleArray0, 0, 0);
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        StatUtils.max(doubleArray0, (-1), 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumSq(doubleArray0, (-3154), (-3154));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sum(doubleArray0, 1, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      double[] doubleArray0 = new double[7];
      double double0 = StatUtils.min(doubleArray0, 1, 0);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, 0, 1852);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (double) 0, (-1006), 7);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 0, 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, 637.5);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: 637.5
         //
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, 3217, 3217);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-1), (-1), (double) 0);
        fail("Expecting exception: IllegalArgumentException");
