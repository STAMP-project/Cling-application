...
public class LocalTime_ESTest extends LocalTime_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        localTime_Property0.addNoWrapToCopy(998);
  ...
  public void test01()  throws Throwable  {
      ...
      LocalTime localTime1 = localTime_Property0.addNoWrapToCopy(998);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        localTime0.MIDNIGHT.toString("org.joda.time.LocalTime", locale0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.toString("The divisor must be at least 2");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      LocalTime localTime1 = localTime0.minusMillis(65563);
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test11()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      LocalTime localTime1 = localTime0.minusSeconds(35);
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test13()  throws Throwable  {
      LocalTime localTime0 = LocalTime.MIDNIGHT;
      LocalTime localTime1 = localTime0.minusMinutes(2147481778);
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      LocalTime localTime1 = localTime0.minusHours(2144496883);
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test19()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      LocalTime localTime1 = localTime0.plusSeconds((-454));
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test22()  throws Throwable  {
      LocalTime localTime0 = LocalTime.MIDNIGHT;
      LocalTime localTime1 = localTime0.plusHours((-1471));
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withFieldAdded((DurationFieldType) null, (-2164));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      DurationFieldType durationFieldType0 = DurationFieldType.millis();
      LocalTime localTime1 = localTime0.MIDNIGHT.withFieldAdded(durationFieldType0, (-1663));
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.MIDNIGHT.withField(dateTimeFieldType0, (-2779));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -2779 for hourOfHalfday must be in the range [0,11]
         //
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withField((DateTimeFieldType) null, 18);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withField(dateTimeFieldType0, (-2147483022));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -2147483022 for secondOfDay must be in the range [0,86399]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      ...
      LocalTime localTime1 = LocalTime.fromMillisOfDay((-4100L), (Chronology) buddhistChronology0);
  ...
  public void test39()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      LocalTime localTime1 = localTime0.plusMinutes(4340);
      boolean boolean0 = localTime0.equals(localTime1);
      assertFalse(boolean0);
      assertFalse(localTime1.equals((Object)localTime0));
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.MIDNIGHT.getValue(666);
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.MIDNIGHT.getField((-721));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withMinuteOfHour((-349));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -349 for minuteOfHour must be in the range [0,59]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      LocalTime localTime0 = new LocalTime(957L, (DateTimeZone) null);
      assertEquals(4, localTime0.size());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withSecondOfMinute(65535);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test57()  throws Throwable  {
      LocalTime localTime0 = new LocalTime(10, 10, 10);
      assertEquals(4, localTime0.size());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withMillisOfSecond((-3022));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -3022 for millisOfSecond must be in the range [0,999]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withMillisOfDay((-1532));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -1532 for millisOfDay must be in the range [0,86399999]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        localTime0.withHourOfDay((-4737));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -4737 for hourOfDay must be in the range [0,23]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      ...
      LocalTime localTime1 = localTime_Property0.addWrapFieldToCopy((-1179));
      assertNotSame(localTime1, localTime0);
  }
  ...
  public void test78()  throws Throwable  {
      LocalTime localTime0 = LocalTime.now();
      LocalTime.Property localTime_Property0 = localTime0.millisOfDay();
      LocalTime localTime1 = localTime_Property0.addCopy(1372L);
      assertNotSame(localTime1, localTime0);
  }

  @Test(timeout = 4000)
  public void test79()  throws Throwable  {
      LocalTime localTime0 = LocalTime.fromMillisOfDay(1000L, (Chronology) null);
      LocalTime.Property localTime_Property0 = localTime0.hourOfDay();
