...
public class UnicodeEscaper_ESTest extends UnicodeEscaper_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.above((-3803));
  ...
  public void test1()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1350);
      StringWriter stringWriter0 = new StringWriter(0);
  ...
  public void test3()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.above(493);
      boolean boolean0 = unicodeEscaper0.translate(19, (Writer) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1625, 0);
      boolean boolean0 = unicodeEscaper0.translate(4095, (Writer) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test5()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1625, 4095);
      boolean boolean0 = unicodeEscaper0.translate(54, (Writer) null);
      assertFalse(boolean0);
  }
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate(4095, (Writer) null);
        fail("Expecting exception: NullPointerException");
