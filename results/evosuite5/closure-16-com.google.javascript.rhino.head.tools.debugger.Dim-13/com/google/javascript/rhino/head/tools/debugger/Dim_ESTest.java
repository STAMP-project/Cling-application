...
public class Dim_ESTest extends Dim_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ContextFactory contextFactory0 = new ContextFactory();
      dim0.attachTo(contextFactory0);
      boolean boolean0 = dim0.stringIsCompilableUnit("REF_MEMBER");
      assertTrue(boolean0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dim0.compileScript("\"VDa^f|!vrqK'&%", "\"VDa^f|!vrqK'&%");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // unterminated string literal (\"VDa^f|!vrqK'&%#1)
         //
         verifyException("com.google.javascript.rhino.head.DefaultErrorReporter", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      dim0.attachTo(contextFactory0);
      ImporterTopLevel importerTopLevel0 = new ImporterTopLevel();
      NativeGenerator nativeGenerator0 = new NativeGenerator(importerTopLevel0, (NativeFunction) null, importerTopLevel0);
  ...
  public void test21()  throws Throwable  {
      Dim dim0 = new Dim();
      Dim.FunctionSource dim_FunctionSource0 = dim0.functionSourceByName("ZYc?j}qc");
  ...
  public void test26()  throws Throwable  {
      Dim dim0 = new Dim();
      Dim.SourceInfo dim_SourceInfo0 = dim0.sourceInfo("__proRt$H_");
  ...
  public void test27()  throws Throwable  {
      Dim dim0 = new Dim();
      String string0 = dim0.eval("yq#=%@ss%~t");
      assertEquals("undefined", string0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      dim0.attachTo(contextFactory0);
      NativeObject nativeObject0 = new NativeObject();
      Object object0 = dim0.getObjectProperty(nativeObject0, "5`}<D+!Pk&7");
