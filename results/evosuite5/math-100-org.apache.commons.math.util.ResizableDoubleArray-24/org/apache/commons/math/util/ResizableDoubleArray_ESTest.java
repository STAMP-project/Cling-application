...
public class ResizableDoubleArray_ESTest extends ResizableDoubleArray_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      resizableDoubleArray0.addElement(797.7791);
      double double0 = resizableDoubleArray0.addElementRolling(357.20379);
      assertEquals(1, resizableDoubleArray0.start());
      assertEquals(797.7791, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.setNumElements(1934);
      assertEquals(1934, resizableDoubleArray0.getNumElements());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        resizableDoubleArray0.setNumElements((-1696));
  ...
  public void test05()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(4521, 4521);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.setElement(13, 0);
      resizableDoubleArray0.setElement(0, 3138.0);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.setElement((-2507), (-2507));
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.getElement((-1435));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.discardFrontElements((-913));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.numElements = 1658;
      // Undeclared exception!
      try { 
        resizableDoubleArray0.addElementRolling(1658);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.setElement(1196, (-869.5));
      resizableDoubleArray0.addElement((-869.5));
      assertEquals(1198, resizableDoubleArray0.getNumElements());
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(3704, 3704);
      int int0 = resizableDoubleArray0.getNumElements();
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(3704.5F, resizableDoubleArray0.getContractionCriteria(), 0.01F);
      assertEquals(3704.0F, resizableDoubleArray0.getExpansionFactor(), 0.01F);
      assertEquals(0, int0);
  }
  ...
  public void test23()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(849, 849);
      int int0 = resizableDoubleArray0.getInternalLength();
      assertEquals(0, resizableDoubleArray0.start());
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(849.5F, resizableDoubleArray0.getContractionCriteria(), 0.01F);
      assertEquals(849, int0);
      assertEquals(849.0F, resizableDoubleArray0.getExpansionFactor(), 0.01F);
      assertEquals(0, resizableDoubleArray0.getNumElements());
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(1783, 2.5F, 2.5F);
      double[] doubleArray0 = resizableDoubleArray0.getValues();
      assertEquals(0, resizableDoubleArray0.start());
      assertEquals(1783, doubleArray0.length);
  ...
  public void test25()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = null;
      try {
        resizableDoubleArray0 = new ResizableDoubleArray((-1), (-1), 0.0F, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = null;
      try {
        resizableDoubleArray0 = new ResizableDoubleArray(1, 2.5F, 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.setElement(3182, 0.0);
      resizableDoubleArray0.getElement(0);
      assertEquals(3183, resizableDoubleArray0.getNumElements());
  }
