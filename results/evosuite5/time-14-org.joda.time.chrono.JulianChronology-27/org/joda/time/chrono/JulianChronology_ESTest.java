...
public class JulianChronology_ESTest extends JulianChronology_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = julianChronology0.calculateFirstDayOfYearMillis(504);
      assertEquals((-46262361600000L), long0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstanceUTC();
      long long0 = julianChronology0.calculateFirstDayOfYearMillis(324584);
      assertEquals(10180924646400000L, long0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      long long0 = julianChronology0.calculateFirstDayOfYearMillis(2318);
      assertEquals(10983168000000L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      try { 
        julianChronology0.getDateMidnightMillis(370, 370, 370);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      try { 
        julianChronology0.getDateMidnightMillis((-3012), (-3012), (-3012));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -3012 for monthOfYear must be in the range [1,12]
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
