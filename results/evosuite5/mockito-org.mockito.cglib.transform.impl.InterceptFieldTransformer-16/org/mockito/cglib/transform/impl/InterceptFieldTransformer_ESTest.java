...
public class InterceptFieldTransformer_ESTest extends InterceptFieldTransformer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        interceptFieldTransformer0.visit(1, 1, "0)j4_K$g~`OA&`N6", "0)j4_K$g~`OA&`N6", "0)j4_K$g~`OA&`N6", stringArray0);
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        interceptFieldTransformer0.visit((-54), (-54), "0)j4_K$g~`OA&`N6", "0)j4_K$g~`OA&`N6", "0)j4_K$g~`OA&`N6", stringArray0);
        fail("Expecting exception: NullPointerException");
