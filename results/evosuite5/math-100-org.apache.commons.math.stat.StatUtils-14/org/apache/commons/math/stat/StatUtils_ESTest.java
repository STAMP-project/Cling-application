...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      double double0 = StatUtils.varianceDifference(doubleArray0, doubleArray0, (-1230.8150887536126));
      assertEquals(3.7252902984619143E-10, double0, 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, 475.642344223155);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 179, 179);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      double[] doubleArray0 = new double[6];
      double double0 = StatUtils.max(doubleArray0, 0, 1);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumSq(doubleArray0, 2729, (-2980));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sum(doubleArray0, (-1067), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, 0, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      double double0 = StatUtils.variance(doubleArray0, 0.0, 0, 0);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, 0, 0, (-2054.781874));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: -2054.781874
         //
  ...
  public void test25()  throws Throwable  {
      double[] doubleArray0 = new double[4];
      double double0 = StatUtils.variance(doubleArray0, (-376.779));
      assertEquals(0.0, double0, 0.01);
  }
