...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, (-1), (-895));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.product((double[]) null, 2, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sum(doubleArray0, 2, 2);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      double[] doubleArray0 = new double[6];
      double double0 = StatUtils.min(doubleArray0, 2, 1);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, (-2389), (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (double) (-2251), (-2251), (-2684));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-1052.304142566707));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: -1052.304142566707
         //
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, 2213, 2213);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-5026), (-5026), 847.1796224137);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      double double0 = StatUtils.variance(doubleArray0, 1803.9609514);
      assertEquals(0.0, double0, 0.01);
  }
