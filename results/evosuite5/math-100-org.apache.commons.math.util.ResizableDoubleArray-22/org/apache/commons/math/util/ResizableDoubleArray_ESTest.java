...
public class ResizableDoubleArray_ESTest extends ResizableDoubleArray_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(1017);
  ...
  public void test01()  throws Throwable  {
      ...
      resizableDoubleArray0.setNumElements(534);
      assertEquals(534, resizableDoubleArray0.getNumElements());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try {
        resizableDoubleArray0 = new ResizableDoubleArray((-1871));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The initial capacity supplied: -1871must be a positive integer
         //
         verifyException("org.apache.commons.math.util.ResizableDoubleArray", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2941, 3489.635F);
      // Undeclared exception!
      try { 
        resizableDoubleArray0.setExpansionMode(2941);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray();
      resizableDoubleArray0.numElements = 2000;
      resizableDoubleArray0.setElement(0, 0.0);
      assertEquals(2000, resizableDoubleArray0.getNumElements());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.setElement((-2520), (-2520));
  ...
  public void test11()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2896, 2896);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2896, 2896);
      resizableDoubleArray0.setNumElements(2896);
      resizableDoubleArray0.expansionMode = 629;
      double double0 = resizableDoubleArray0.addElementRolling(2275.51436647);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.discardFrontElements((-384));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2934, 2934);
      // Undeclared exception!
      try { 
        resizableDoubleArray0.discardFrontElements(2934);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      resizableDoubleArray0.discardFrontElements(0);
      assertEquals(0, resizableDoubleArray0.getNumElements());
      assertEquals(3490.135F, resizableDoubleArray0.getContractionCriteria(), 0.01F);
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(0, resizableDoubleArray0.start());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.checkContractExpand(2972.3F, (-1837.0F));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        resizableDoubleArray0.checkContractExpand(0.0F, 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      double double0 = resizableDoubleArray0.addElementRolling((-1933.9425694092242));
      assertEquals(1, resizableDoubleArray0.getNumElements());
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2934);
      resizableDoubleArray0.addElement(1632.0);
      assertEquals(1, resizableDoubleArray0.getNumElements());
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(133, 133);
      int int0 = resizableDoubleArray0.getNumElements();
      assertEquals(133.5F, resizableDoubleArray0.getContractionCriteria(), 0.01F);
      assertEquals(0, resizableDoubleArray0.start());
      assertEquals(133.0F, resizableDoubleArray0.getExpansionFactor(), 0.01F);
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(0, int0);
  }
  ...
  public void test26()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = null;
      try {
        resizableDoubleArray0 = new ResizableDoubleArray((-3511), (-3511), (-3511), (-3511));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(133, 133);
      resizableDoubleArray0.setExpansionFactor(133);
      assertEquals(0, resizableDoubleArray0.getNumElements());
      assertEquals(0, resizableDoubleArray0.start());
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(133.0F, resizableDoubleArray0.getExpansionFactor(), 0.01F);
  ...
  public void test28()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2934);
      resizableDoubleArray0.addElementRolling(2934);
      resizableDoubleArray0.addElement(0.0);
      resizableDoubleArray0.addElement(0.0);
  ...
  public void test30()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2896, 2896);
      resizableDoubleArray0.setElement(2896, 0.0);
      assertEquals(2897, resizableDoubleArray0.getNumElements());
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      ResizableDoubleArray resizableDoubleArray0 = new ResizableDoubleArray(2934, 2934, 2934);
      double[] doubleArray0 = resizableDoubleArray0.getElements();
      assertEquals(0, resizableDoubleArray0.start());
      assertEquals(2934.0F, resizableDoubleArray0.getContractionCriteria(), 0.01F);
      assertEquals(0, doubleArray0.length);
      assertEquals(0, resizableDoubleArray0.getExpansionMode());
      assertEquals(2934.0F, resizableDoubleArray0.getExpansionFactor(), 0.01F);
  }
}
