...
public class EthiopicChronology_ESTest extends EthiopicChronology_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      ...
      try { 
        EthiopicChronology.getInstance((DateTimeZone) null, 1496);
  ...
  public void test5()  throws Throwable  {
      EthiopicChronology ethiopicChronology0 = EthiopicChronology.getInstance();
      int int0 = ethiopicChronology0.getYear(1);
      assertEquals(1962, int0);
  }

  @Test(timeout = 4000)
  public void test6()  throws Throwable  {
      EthiopicChronology ethiopicChronology0 = new EthiopicChronology((Chronology) null, "{R~QAgcmV)uL9CP", 1);
