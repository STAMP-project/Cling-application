...
public class NativeContinuation_ESTest extends NativeContinuation_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      int int0 = nativeContinuation0.findPrototypeId("Mxcj`f!aw%");
      assertEquals(0, int0);
  }
  ...
  public void test1()  throws Throwable  {
      NativeContinuation nativeContinuation0 = new NativeContinuation();
      IdFunctionObject idFunctionObject0 = new IdFunctionObject(nativeContinuation0, nativeContinuation0, (-2196), 0);
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // BAD FUNCTION ID=-2196 MASTER=com.google.javascript.rhino.head.NativeContinuation@1
         //
  ...
  public void test5()  throws Throwable  {
      NativeContinuation nativeContinuation0 = new NativeContinuation();
      IdFunctionObject idFunctionObject0 = new IdFunctionObject(nativeContinuation0, "Continuation", 8, "Continuation", 2, nativeContinuation0);
      boolean boolean0 = NativeContinuation.isContinuationConstructor(idFunctionObject0);
  ...
  public void test6()  throws Throwable  {
      NativeContinuation nativeContinuation0 = new NativeContinuation();
      IdFunctionObject idFunctionObject0 = new IdFunctionObject(nativeContinuation0, "Mxcjkf!aw%", 0, "Mxcjkf!aw%", 4, nativeContinuation0);
      boolean boolean0 = NativeContinuation.isContinuationConstructor(idFunctionObject0);
      assertFalse(boolean0);
  }
