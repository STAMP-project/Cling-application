...
public class ASMifierAbstractVisitor_ESTest extends ASMifierAbstractVisitor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double((-2738.1302895142));
      ASMifierAbstractVisitor.appendConstant(stringBuffer0, double0);
      assertEquals(30, stringBuffer0.length());
      assertEquals("new Double(\"-2738.1302895142\")", stringBuffer0.toString());
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals("new Long(-4317L)", stringBuffer0.toString());
  ...
  public void test02()  throws Throwable  {
      StringBuffer stringBuffer0 = new StringBuffer();
      Float float0 = new Float((-1.4815776F));
      ASMifierAbstractVisitor.appendConstant(stringBuffer0, float0);
      assertEquals("new Float(\"-1.4815776\")", stringBuffer0.toString());
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals("new Character((char)94)", stringBuffer0.toString());
      assertEquals(23, stringBuffer0.length());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(23, stringBuffer0.length());
      assertEquals("new Short((short)-1742)", stringBuffer0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ASMifierAbstractVisitor aSMifierAbstractVisitor0 = new ASMifierAbstractVisitor("LG;'[U{?s[N");
