...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      double double0 = StatUtils.varianceDifference(doubleArray0, doubleArray0, (-438.7292499768294));
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, (-1334.7371));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 0, (-758));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, (-1), (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.product(doubleArray0, 512, 4860);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumSq(doubleArray0, 603, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.min(doubleArray0, 2032, 2);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      // Undeclared exception!
      try { 
        StatUtils.sumLog((double[]) null, 0, (-1579));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      double double0 = StatUtils.variance(doubleArray0, 0.8573, 0, 0);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (-134), (-134));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, (-1962), 2304);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, 2322, 4860, 0.0);
        fail("Expecting exception: IllegalArgumentException");
