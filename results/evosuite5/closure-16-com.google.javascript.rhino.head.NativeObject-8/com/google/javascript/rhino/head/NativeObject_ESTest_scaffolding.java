...
public class NativeObject_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NativeObject_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.google.javascript.rhino.head.NativeObject$EntrySet$1$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, NativeObject_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, NativeObject_ESTest_scaffolding.class.getClassLoader()));
  }
