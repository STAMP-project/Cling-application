...
public class FieldProviderTransformer_ESTest extends FieldProviderTransformer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.visit(26, 26, "void setField(int, Object)", "void setField(int, Object)", "void setField(int, Object)", stringArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.visit((-4), (-4), "T:g).Fg\"{/:o", "T:g).Fg\"{/:o", "T:g).Fg\"{/:o", stringArray0);
        fail("Expecting exception: NullPointerException");
