...
public class InterceptFieldTransformer_ESTest extends InterceptFieldTransformer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Type type0 = Type.getObjectType("chY=");
      // Undeclared exception!
      try { 
        interceptFieldTransformer0.begin_class(2, 8, "chY=", type0, (Type[]) null, "chY=");
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        interceptFieldTransformer0.begin_class(1733, 1733, "$GLIBREAD_WRITE_CALLBACK", type0, typeArray0, "$GLIBREAD_WRITE_CALLBACK");
        fail("Expecting exception: NullPointerException");
