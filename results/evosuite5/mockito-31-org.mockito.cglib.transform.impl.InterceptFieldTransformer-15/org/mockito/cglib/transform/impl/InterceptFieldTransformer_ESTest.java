...
public class InterceptFieldTransformer_ESTest extends InterceptFieldTransformer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        interceptFieldTransformer0.begin_class(0, 0, "Label offset position has not been resolved yet", type0, typeArray0, "Label offset position has not been resolved yet");
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        interceptFieldTransformer0.begin_class((-64), (-64), "Label offset position has not been resolved yet", type0, typeArray0, "Label offset position has not been resolved yet");
        fail("Expecting exception: NullPointerException");
