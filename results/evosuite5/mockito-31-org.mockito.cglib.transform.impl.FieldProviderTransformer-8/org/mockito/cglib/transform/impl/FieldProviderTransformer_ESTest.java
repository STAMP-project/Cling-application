...
public class FieldProviderTransformer_ESTest extends FieldProviderTransformer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.begin_class(3, 6, "Class[]", type0, (Type[]) null, "Class[]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.visit((-78), (-78), "s", "s", "s", stringArray0);
        fail("Expecting exception: NullPointerException");
