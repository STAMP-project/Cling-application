...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray1, (-3877.75));
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, 793.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 31, 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, (-1800), 796);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.min(doubleArray0, (-3552), (-3552));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, (-1), 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 1.0, (-2583), (-2583));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 1369, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      double double0 = StatUtils.percentile(doubleArray0, 50.0);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, 4261, 4261);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-1154), (-1154), (double) (-1154));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      double double0 = StatUtils.variance(doubleArray0, 793.0);
      assertEquals(0.0, double0, 0.01);
  }
