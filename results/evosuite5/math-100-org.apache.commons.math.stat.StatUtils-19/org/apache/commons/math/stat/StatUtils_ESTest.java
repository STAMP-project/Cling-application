...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray0, (-621.09260902));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 4046, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sum(doubleArray0, 31, (-695));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      double[] doubleArray0 = new double[4];
      double double0 = StatUtils.sumLog(doubleArray0, 0, 0);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 1.0, 0, 123);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (-2079), (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (double) (-1));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: -1.0
         //
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, 1567, 1567);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-1), 1, 676.5207237368);
        fail("Expecting exception: IllegalArgumentException");
