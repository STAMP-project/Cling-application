...
public class JulianChronology_ESTest extends JulianChronology_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = julianChronology0.calculateFirstDayOfYearMillis(20587493);
      assertEquals(649629701769600000L, long0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      long long0 = julianChronology0.calculateFirstDayOfYearMillis((-2162));
      assertEquals((-130394880000000L), long0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstanceUTC();
      long long0 = julianChronology0.calculateFirstDayOfYearMillis(20587500);
      assertEquals(649629922608000000L, long0);
  }
  ...
  public void test08()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      try { 
        julianChronology0.getDateMidnightMillis((-2162), (-2162), (-2162));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Value -2162 for monthOfYear must be in the range [1,12]
         //
