...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray1, doubleArray0, (-2113.445637281));
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 31, 47);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, (-1978), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.product(doubleArray0, (-568), 454);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumSq(doubleArray0, (-1030), (-1100));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sum(doubleArray0, (-1), (-66));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.min(doubleArray0, 1297, 1297);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, (-1978), (-1978));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (double) (-2470), 2, 1032);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, (-1825), (-1825));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, (-642.2859109911225));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: -642.2859109911225
         //
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, 1236, 1236);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, 0, 2187, 0.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      double double0 = StatUtils.variance(doubleArray0, (-121.4));
      assertEquals(Double.NaN, double0, 0.01);
  }
