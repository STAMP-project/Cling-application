...
public class JulianChronology_ESTest extends JulianChronology_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      int int0 = JulianChronology.adjustYearForSet((-137));
  ...
  public void test6()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      int int0 = julianChronology0.getDaysInMonthMax(62035200000L);
  ...
  public void test7()  throws Throwable  {
      JulianChronology julianChronology0 = JulianChronology.getInstance();
      try { 
        julianChronology0.getDateMidnightMillis(1804, 1804, 1804);
        fail("Expecting exception: IllegalArgumentException");
