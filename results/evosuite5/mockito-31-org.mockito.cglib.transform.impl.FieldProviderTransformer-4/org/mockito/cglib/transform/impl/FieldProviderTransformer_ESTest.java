...
public class FieldProviderTransformer_ESTest extends FieldProviderTransformer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.begin_class(0, 0, "*>)6n3HU^#MyX;=B^]", type0, (Type[]) null, "*>)6n3HU^#MyX;=B^]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fieldProviderTransformer0.begin_class((-1), (-1), "*>)6n3HU^#MyX;=B^]", type0, (Type[]) null, "*>)6n3HU^#MyX;=B^]");
        fail("Expecting exception: NullPointerException");
