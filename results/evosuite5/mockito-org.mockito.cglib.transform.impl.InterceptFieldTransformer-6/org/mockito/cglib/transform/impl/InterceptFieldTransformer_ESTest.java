...
public class InterceptFieldTransformer_ESTest extends InterceptFieldTransformer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        interceptFieldTransformer0.begin_class(178, 178, "N(}2,%w,1kwJ@Nq{", type0, typeArray0, "N(}2,%w,1kwJ@Nq{");
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        interceptFieldTransformer0.begin_class(1541, 1541, "N(}2,%w,1kwJ@Nq{", type0, typeArray0, "N(}2,%w,1kwJ@Nq{");
        fail("Expecting exception: NullPointerException");
