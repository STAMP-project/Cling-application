...
public class Weeks_ESTest extends Weeks_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      Weeks weeks0 = Weeks.MIN_VALUE;
      Weeks weeks1 = weeks0.MAX_VALUE.dividedBy(604800);
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        Weeks.parseWeeks("kh4(4Xu");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid format: \"kh4(4Xu\"
         //
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        weeks0.TWO.multipliedBy(2147483281);
        fail("Expecting exception: ArithmeticException");
      
      } catch(ArithmeticException e) {
         //
         // Multiplication overflows an int: 2 * 2147483281
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
