...
public class AbstractPeriod_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.base.AbstractPeriod"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractPeriod_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.PeriodParser", false, AbstractPeriod_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodPrinter", false, AbstractPeriod_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractPeriod_ESTest_scaffolding.class.getClassLoader()); 
