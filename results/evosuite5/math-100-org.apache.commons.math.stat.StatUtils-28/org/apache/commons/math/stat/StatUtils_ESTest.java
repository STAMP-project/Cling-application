...
public class StatUtils_ESTest extends StatUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StatUtils.varianceDifference(doubleArray0, doubleArray1, 774.3875908971);
  ...
  public void test01()  throws Throwable  {
      double[] doubleArray0 = new double[5];
      double double0 = StatUtils.varianceDifference(doubleArray0, doubleArray0, (-648.75120626));
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        StatUtils.mean(doubleArray0, 0, 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.max(doubleArray0, 4019, (-256));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      double[] doubleArray0 = new double[5];
      double double0 = StatUtils.sumSq(doubleArray0, 0, 2);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.min(doubleArray0, 1795, 31);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.sumLog(doubleArray0, 449, 449);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.variance(doubleArray0, 1852.9523, (-1), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.percentile(doubleArray0, 1611.5157);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // invalid quantile value: 1611.5157
         //
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StatUtils.geometricMean(doubleArray0, (-944), (-944));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      double[] doubleArray0 = new double[4];
      double double0 = StatUtils.percentile(doubleArray0, 2, 0, (double) 2);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      double[] doubleArray0 = new double[5];
      double double0 = StatUtils.variance(doubleArray0, 504.84665444464);
      assertEquals(0.0, double0, 0.01);
  }
