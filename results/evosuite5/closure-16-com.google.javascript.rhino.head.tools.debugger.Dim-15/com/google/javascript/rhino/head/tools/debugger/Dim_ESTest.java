...
public class Dim_ESTest extends Dim_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(baseFunction0).when(scopeProvider0).getScope();
      dim0.setScopeProvider(scopeProvider0);
      dim0.attachTo(contextFactory0);
      // Undeclared exception!
      try { 
        dim0.evalScript("3_qkR4L1r)_Ro1?|]", "3_qkR4L1r)_Ro1?|]");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // missing ; before statement (3_qkR4L1r)_Ro1?|]#1)
         //
  ...
  public void test02()  throws Throwable  {
      ...
      ContextFactory contextFactory0 = new ContextFactory();
      dim0.attachTo(contextFactory0);
      String string0 = dim0.objectToString(dim0);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dim0.evalScript("3_kR4L;r)_Ro1?|]", "3_kR4L;r)_Ro1?|]");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // missing ; before statement (3_kR4L;r)_Ro1?|]#1)
         //
         verifyException("com.google.javascript.rhino.head.DefaultErrorReporter", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      NativeGenerator nativeGenerator0 = new NativeGenerator(baseFunction0, nativeFunction0, nativeFunction0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dim0.getObjectProperty(topLevel0, 3);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dim0.getObjectProperty(topLevel0, "!`7]");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test12()  throws Throwable  {
      ...
      ScriptableObject.defineProperty((Scriptable) topLevel0, "!`7]", (Object) dialog_ModalityType0, 4);
      Object object0 = dim0.getObjectProperty(topLevel0, "!`7]");
      assertEquals(Dialog.ModalityType.MODELESS, object0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dim0.getObjectProperty(nativeArray0, 0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test23()  throws Throwable  {
      Dim dim0 = new Dim();
      Dim.FunctionSource dim_FunctionSource0 = dim0.functionSourceByName(";v &5P");
  ...
  public void test28()  throws Throwable  {
      Dim dim0 = new Dim();
      Dim.SourceInfo dim_SourceInfo0 = dim0.sourceInfo("jn");
  ...
  public void test29()  throws Throwable  {
      Dim dim0 = new Dim();
      String string0 = dim0.eval("#S6DLU");
      assertEquals("undefined", string0);
  }
