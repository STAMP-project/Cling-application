...
public class Vector3D_ESTest extends Vector3D_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2065.7193085235585, 2065.7193085235585);
      Vector3D vector3D1 = Vector3D.plusJ;
      double double0 = Vector3D.angle(vector3D1, vector3D0);
      assertEquals(1.6920207203981128, double0, 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.minusJ;
      Vector3D vector3D1 = vector3D0.minusI.subtract(0.0, vector3D0);
      Vector3D vector3D2 = vector3D1.orthogonal();
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, 197.652975);
      Vector3D vector3D1 = null;
      try {
        vector3D1 = new Vector3D(0.0, (Vector3D) null, (-730.14186388797), vector3D0, 2244.13755146, vector3D0, 2244.13755146, (Vector3D) null);
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-1310.901630984136));
      double double0 = vector3D0.getAlpha();
      assertEquals(0.8574944371923104, vector3D0.getDelta(), 0.01);
      assertEquals((-3.141592653589793), double0, 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.minusJ;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-3987.48109347), vector3D0, 0.0, vector3D0);
      assertEquals(3987.48109347, vector3D1.getNorm(), 0.01);
      assertEquals(3987.48109347, vector3D1.getY(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals((-1.4486575385254128), vector3D0.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.minusK;
      Vector3D vector3D1 = new Vector3D((-2106.7323284123), vector3D0);
      assertEquals(1.5707963267948966, vector3D1.getDelta(), 0.01);
      assertEquals((-3.141592653589793), vector3D1.getAlpha(), 0.01);
  }
