...
public class UnicodeEscaper_ESTest extends UnicodeEscaper_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf((-429), (-429));
  ...
  public void test3()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(2252, (-415));
      String string0 = unicodeEscaper0.translate((CharSequence) "FFFFFE61");
      assertEquals("\\u0046\\u0046\\u0046\\u0046\\u0046\\u0045\\u0036\\u0031", string0);
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(3981, 3981);
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate(3981, (Writer) null);
  ...
  public void test5()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(3981, 3981);
      boolean boolean0 = unicodeEscaper0.translate((-963), (Writer) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test6()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between((-2021), 21);
      StringWriter stringWriter0 = new StringWriter(274);
