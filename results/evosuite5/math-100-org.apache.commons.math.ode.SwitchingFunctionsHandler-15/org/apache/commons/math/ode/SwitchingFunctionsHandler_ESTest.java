...
public class SwitchingFunctionsHandler_ESTest extends SwitchingFunctionsHandler_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      switchingFunctionsHandler0.add(switchingFunction0, 1962, 1962, 1962);
      double[] doubleArray0 = new double[1];
      boolean boolean0 = switchingFunctionsHandler0.reset(1962, doubleArray0);
  ...
  public void test2()  throws Throwable  {
      ...
      switchingFunctionsHandler0.add(switchingFunction0, 1962, 1962, 1962);
      double[] doubleArray0 = new double[1];
      switchingFunctionsHandler0.stepAccepted(1962, doubleArray0);
  ...
  public void test4()  throws Throwable  {
      SwitchingFunctionsHandler switchingFunctionsHandler0 = new SwitchingFunctionsHandler();
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      doReturn((double)1981, (double)1981, 0.0).when(switchingFunction0).g(anyDouble() , any(double[].class));
      switchingFunctionsHandler0.add(switchingFunction0, 1981, 1981, 1981);
      double[] doubleArray0 = new double[1];
  ...
  public void test7()  throws Throwable  {
      ...
      SwitchingFunction switchingFunction0 = mock(SwitchingFunction.class, new ViolatedAssumptionAnswer());
      switchingFunctionsHandler0.add(switchingFunction0, 1984, 1984, 1984);
      boolean boolean0 = switchingFunctionsHandler0.isEmpty();
      assertFalse(boolean0);
  }
