...
public class RegressionTest0 {
    ...
    public void test0497() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            long long41 = iSOChronology5.getDateTimeMillis(10, (int) (short) -1, 10, (int) (short) 10);
            org.junit.Assert.fail("Expected exception of type org.joda.time.IllegalFieldValueException; message: Value -1 for monthOfYear must be in the range [1,12]");
        } catch (org.joda.time.IllegalFieldValueException e) {
        // Expected exception.
        }
    ...
    public void test0498() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            long long16 = iSOChronology1.getDateTimeMillis((-1000L), (int) (short) 100, (int) 'a', (int) (byte) 0, (int) (short) 0);
            org.junit.Assert.fail("Expected exception of type org.joda.time.IllegalFieldValueException; message: Value 100 for hourOfDay must be in the range [0,23]");
        } catch (org.joda.time.IllegalFieldValueException e) {
        // Expected exception.
        }
    ...
    public void test0499() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            long long11 = iSOChronology0.getDateTimeMillis((int) (byte) 0, 10, (int) (byte) 100, 10, (int) (byte) 0, 10, (int) (byte) -1);
            org.junit.Assert.fail("Expected exception of type org.joda.time.IllegalFieldValueException; message: Value -1 for millisOfSecond must be in the range [0,999]");
        } catch (org.joda.time.IllegalFieldValueException e) {
        // Expected exception.
        }
    ...
    public void test0500() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            long long28 = iSOChronology5.getDateTimeMillis((int) (short) 100, (int) (byte) -1, (int) 'a', (int) (short) 100, 1, (int) (short) 100, (int) (short) -1);
            org.junit.Assert.fail("Expected exception of type org.joda.time.IllegalFieldValueException; message: Value 100 for hourOfDay must be in the range [0,23]");
        } catch (org.joda.time.IllegalFieldValueException e) {
        // Expected exception.
        }
