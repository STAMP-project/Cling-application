...
public class RegressionTest3 {
    ...
    public void test1566() throws Throwable {
        ...
        boolean boolean40 = compilerEnvirons39.isGenerateDebugInfo();
        boolean boolean41 = compilerEnvirons39.isStrictMode();
        boolean boolean42 = compilerEnvirons39.isRecordingComments();
        boolean boolean43 = compilerEnvirons39.reportWarningAsError();
    ...
    public void test1573() throws Throwable {
        ...
        boolean boolean41 = compilerEnvirons0.isReservedKeywordAsIdentifier();
        org.junit.Assert.assertNotNull(strArray2);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
        org.junit.Assert.assertNotNull(strArray13);
