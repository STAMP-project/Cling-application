...
public class RegressionTest4 {
    ...
    public void test2138() throws Throwable {
        ...
        double double34 = org.apache.commons.math.stat.StatUtils.product(doubleArray28);
        double double35 = org.apache.commons.math.stat.StatUtils.product(doubleArray28);
        double double36 = org.apache.commons.math.stat.StatUtils.meanDifference(doubleArray3, doubleArray28);
        double double38 = org.apache.commons.math.stat.StatUtils.variance(doubleArray28, 26.999999999999996d);
        org.junit.Assert.assertNotNull(doubleArray3);
        org.junit.Assert.assertEquals(java.util.Arrays.toString(doubleArray3), "[10.0, 10.0, 1.0]");
        org.junit.Assert.assertTrue("'" + double4 + "' != '" + 7.0d + "'", double4 == 7.0d);
        org.junit.Assert.assertTrue("'" + double5 + "' != '" + 4.641588833612779d + "'", double5 == 4.641588833612779d);
        ...
        org.junit.Assert.assertTrue("'" + double36 + "' != '" + 0.0d + "'", double36 == 0.0d);
        org.junit.Assert.assertTrue("'" + double38 + "' != '" + 27.000000000000114d + "'", double38 == 27.000000000000114d);
    }
    ...
    public void test2139() throws Throwable {
        ...
        double double73 = org.apache.commons.math.stat.StatUtils.sumSq(doubleArray69);
        double double74 = org.apache.commons.math.stat.StatUtils.min(doubleArray69);
        double double75 = org.apache.commons.math.stat.StatUtils.variance(doubleArray69);
        double double77 = org.apache.commons.math.stat.StatUtils.variance(doubleArray69, (double) (byte) 1);
        double double78 = org.apache.commons.math.stat.StatUtils.max(doubleArray69);
        double double79 = org.apache.commons.math.stat.StatUtils.meanDifference(doubleArray52, doubleArray69);
        org.junit.Assert.assertNotNull(doubleArray3);
        org.junit.Assert.assertEquals(java.util.Arrays.toString(doubleArray3), "[10.0, 10.0, 1.0]");
        org.junit.Assert.assertTrue("'" + double4 + "' != '" + 7.0d + "'", double4 == 7.0d);
        org.junit.Assert.assertTrue("'" + double5 + "' != '" + 4.641588833612779d + "'", double5 == 4.641588833612779d);
