...
public class RegressionTest0 {
  ...
  public void test0494() throws Throwable {
    ...
    public void test0497() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            long long14 = gJChronology3.getDateTimeMillis((int) (short) 1, (int) (byte) -1, 1, 10, (int) (byte) -1, (int) '4', (int) (short) 1);
            org.junit.Assert.fail("Expected exception of type org.joda.time.IllegalFieldValueException; message: Value -1 for minuteOfHour must be in the range [0,59]");
        } catch (org.joda.time.IllegalFieldValueException e) {
        // Expected exception.
        }
  ...
  public void test0500() throws Throwable {
        ...
        org.joda.time.Chronology chronology32 = gJChronology3.withZone(dateTimeZone31);
        ...
        // The following exception was thrown during execution in test generation
        try {
            org.joda.time.chrono.GJChronology gJChronology46 = org.joda.time.chrono.GJChronology.getInstance(dateTimeZone31, (org.joda.time.ReadableInstant) instant44, (int) '4');
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Invalid min days in first week: 52");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
